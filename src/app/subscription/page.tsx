  ...
  return (
   ...
   <div className="min-w-full">
       ...
       <div className="mt-[30px] inline-flex border border-[#E1E3E5] shadow-[0px 1px 2px #E1E3E5] divide-[#E1E3E5] divide-x rounded-[5px]">
            <button onClick={()=>{setIsYearly(false)}} className={`${isyearly?"bg-white":"bg-sky-600"} hover:text-[#717F87] text-[#0E1823] leading-[16px] text-[13px] font-semibold  py-[15px] px-[25px] rounded-l`}>
                Monthly
            </button>
			<button onClick={()=>{setIsYearly(true)}} className={`${!isyearly?"bg-white":"bg-sky-600"} hover:text-[#717F87] text-[#0E1823] leading-[16px] text-[13px] font-semibold  py-[15px] px-[25px] rounded-l`}>
                Annual
            </button>
		</div>
            ...
            <div key="1" className="w-full bg-[#fff] rounded-[10px] shadow-[0px 1px 2px #E1E3E5] border border-[#E1E3E5] divide-y">
                ...
                <div className="pt-[25px] px-[25px] pb-[35px]">
                    ...
                    <div className="mt-[25px]">
                        <button className="bg-[#006EF5] rounded-[5px] py-[15px] px-[25px] text-[#fff] text-[14px] leading-[17px] font-semibold">Purchase</button>
                    </div>
                </div>
            </div>
