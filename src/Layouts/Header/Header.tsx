  ...
  return (
    <header className="flex flex-col sm:flex-row justify-between m-5 items-center h-auto">
      <div className="flex flex-grow justify-evenly max-w-2xl">
        ...
        <div onClick={()=>{setToggleDropDown(!toggleDropDown)}} className="flex items-center rounded-full max-h-fit px-2 py-2 bg-slate-800  hover:bg-slate-600 cursor-pointer ">
        ...
        <ul className="absolute top-12 w-36 bg-slate-800 bg-opacity-75 px-2 py-1 rounded">
          <li className="hover:bg-slate-600 cursor-pointer px-2 rounded">Profile</li>
          <li className="hover:bg-slate-600 cursor-pointer px-2 rounded">Dashboard</li>
          <li onClick={()=>handleLogout()} className="hover:bg-slate-600 cursor-pointer px-2 rounded">Logout</li>
        </ul>
        }
        </div>
